		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over 600.000 VNĐ</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Diamond</a></li>
					<li><a href="#furniture" data-toggle="tab">Gold </a></li>
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($row['productPrice']);?> VNĐ			
				</span>
				<span class="price-before-discount">
					<?php echo htmlentities($row['productPriceBeforeDiscount']);?> VNĐ
				</span>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Silver</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=5 and subCategory=15");
while ($row=mysqli_fetch_array($ret)) 
{
?>
